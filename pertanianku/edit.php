...
include_once("config.php");
		...
		if(isset($_POST['edit'])){
			...
			$result = mysqli_query($mysqli, "UPDATE barang SET nama_barang='$nama_barang', stock='$stock', harga_jual='$harga_jual', harga_beli='$harga_beli' WHERE id_barang='$id_barang'") or die(mysqli_error($mysqli));
...
$id_barang = $_GET['id_barang'];
$result = mysqli_query($mysqli, "SELECT * FROM barang WHERE id_barang='$id_barang'") or die(mysqli_error($mysqli));
...
<html>
<head>    
    <title>Ubah Data Daftar Hasil Pertanian</title>
...
<div class="wrap">
 ...
 <ul>
      ...
      <li><a href="edit.php">Ubah Data Hasil Pertanian</a></li>
    </ul>
 </nav>
 <!-- akhir bagian menu -->
 ...
 <div id="card">
    <div id="card-content">
      ...
      <form method="post" action="" class="form">
        ...
        <input id="user-stock" class="form-content" type="int" name="stock" value="<?php echo $user_data['stock']; ?>" autocomplete="on" required />
        <div class="form-border"></div>
        <label for="user-harga_jual" style="padding-top:22px">Harga Jual :
          </label>
        <input id="user-harga_jual" class="form-content" type="int" name="harga_jual" value="<?php echo $user_data['harga_jual']; ?>" autocomplete="on" required />
        <div class="form-border"></div>
        <label for="user-harga_beli" style="padding-top:22px">Harga Beli :
          </label>
        <input id="user-harga_beli" class="form-content" type="int" name="harga_beli" value="<?php echo $user_data['harga_beli']; ?>" autocomplete="on" required />
        <div class="form-border"></div>
