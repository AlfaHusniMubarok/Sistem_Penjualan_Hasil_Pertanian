...
include_once("config.php");
		...
		if(isset($_POST['simpan'])){
			...
			$petani= $_POST['nama_petani'];
			$nama_barang= $_POST['nama_barang'];
			$berat= $_POST['berat'];
			$pengeluaran= $_POST['pengeluaran'];
		    $selSto =mysqli_query($mysqli, "SELECT * FROM barang WHERE nama_barang='$nama_barang'");
    $nstock= mysqli_fetch_array($selSto);
    $stock= $nstock['stock'];
    $stok= $stock + $berat;
    $insert =mysqli_query($mysqli, "INSERT INTO pembelian (nama_admin,nama_petani,nama_barang,berat,pengeluaran) VALUES ('$admin','$petani','$nama_barang','$berat','$pengeluaran')");
    if($insert){
        //update stok
        $upstok= mysqli_query($mysqli, "UPDATE barang SET stock='$stok' WHERE nama_barang='$nama_barang'");
    }
    else {
      echo "EROR";
    }
...
$id = $_GET['id_petani'];
$result = mysqli_query($mysqli, "SELECT * FROM petani WHERE id_petani='$id'") or die(mysqli_error($mysqli));
...
<html>
<head>    
    <title>Admin - Verifikasi Pembelian</title>
...
<div class="wrap">
 ...
 <ul>
      ...
      <li><a href="verifpetani.php">Verifikasi Pembelian</a></li>
    </ul>
 </nav>
 <!-- akhir bagian menu -->
 ...
 <div id="card">
    <div id="card-content">
      ...
      <form method="post" action="" class="form">
        ...
        <input id="user-pengeluaran" class="form-content" type="int" name="pengeluaran" autocomplete="on" required />
        <div class="form-border"></div>
